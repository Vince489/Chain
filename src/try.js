...
(async () => {
  ...
  const transferInstruction = new TransactionInstruction('transfer', {
    sender: senderPublicKey,
    recipient: recipientPublicKey,
    amount: 500_000_000, // 5 VRT
  });
  ...
  await blockchain.processTransaction(transaction.sender, transaction.recipient, transaction.amount);
